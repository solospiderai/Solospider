              ...
              <div className="bg-primary border border-transparent rounded-3xl p-9 flex flex-col gap-4.5 relative overflow-hidden transition-all duration-250 hover:-translate-y-1 hover:shadow-[0_40px_70px_-22px_rgba(144,37,242,0.5)] shadow-[0_30px_60px_-22px_rgba(144,37,242,0.4)] reveal d1">
                ...
                <div className="flex flex-col gap-2.5 mt-2 border-t border-white/15 pt-4.5">
                  {[
                    ...
                    "Identify which questions your content should answer",
                    "AEO content suggestions tailored to your industry",
                    "GRO score — see how visible you are vs. competitors",
                    "Structured data recommendations for AI-readability"
                  ].map((item, i) => (
                    <div key={i} className="flex gap-2.5 items-start text-[13.5px] text-white/90">
                      <div className="shrink-0 w-[18px] h-[18px] rounded-full bg-white/15 text-white flex items-center justify-center text-[11px] font-bold mt-0.5">→</div>
                      {item}
                    </div>
                  ))}
                </div>
